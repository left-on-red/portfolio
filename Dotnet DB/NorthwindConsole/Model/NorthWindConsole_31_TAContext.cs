...
{
    public partial class NorthWindConsole_31_TAContext : DbContext
    {
        public NorthWindConsole_31_TAContext()
        {
        }

        public NorthWindConsole_31_TAContext(DbContextOptions<NorthWindConsole_31_TAContext> options)
            : base(options)
        {
        }
